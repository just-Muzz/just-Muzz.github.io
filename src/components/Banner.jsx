...
const Banner = () => {
  ...
  const toRotate = ["Nigerian", "Muslim", "14", "Frontend dev", "React JS"]
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__slideInLeft" : ""}>
                  ...
                  <h1>{"I am just-Muzz"} <span className="txt-rotate" data-rotate='["Nigerian", "Muslim", "14", "Frontend dev", "React JS"]'><span className="wrap">{text}</span></span></h1>
